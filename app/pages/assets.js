...
const metaAssets = () => {
  return [
    ...
    { name: 'description', content: 'No registration, free download to csv, a full history of economic data for a number of indicators accross a range of countries.' },
...
export const title = 'EconomicData.co | Download Free Economic Data for Forex';
